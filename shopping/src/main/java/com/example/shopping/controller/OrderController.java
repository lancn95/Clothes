...
public class OrderController {
	...
	@RequestMapping(value = "/admin/update-status-order", method = RequestMethod.POST)
	private String updateStatusOrder(@ModelAttribute OrderInfo orderInfo) {
		System.out.println("status" + orderInfo.getStatus() + "id: " + orderInfo.getId());
		// update status order by id here

		orderServiceImpl.updateStatus(orderInfo.getId(), orderInfo.getStatus());
